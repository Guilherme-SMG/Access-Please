...
class Desktop:
    def __init__(self, largura, altura):
        ...
        # NOVO: Dicionário para guardar as Hitboxes de cada ícone e do botão Iniciar
        self.hitboxes = {}
    ...
    def desenhar(self, tela):
        ...
        # NOVO: Salvando a Hitbox do botão Doors
        ...
        # NOVO: Guardando as Hitboxes retornadas no dicionário
    ...
    def desenhar_icone_centralizado(self, tela, centro_x, y, nome, imagem):
        ...
        # NOVO: Cria e retorna um Retângulo invisível que cobre a imagem
        return pygame.Rect(pos_img_x, y, largura_img, altura_img)

    # NOVO: Função chamada pelo main.py quando o jogador clica
    def tratar_clique(self, pos_mouse):
        for nome_icone, hitbox in self.hitboxes.items():
            # collidepoint verifica se as coordenadas do mouse X e Y estão dentro deste Retângulo
